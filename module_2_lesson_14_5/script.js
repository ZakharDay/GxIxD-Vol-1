...
function recalcInactiveSquare(square) {
  ...
  switch (true) {
    case square.column < activeSquare.column:
      if (prevSquareInColumn != undefined) {
      ...
      coef = (1 / totalColumnsLeft) * (square.column + 1);
      wCoef = easing(coef);
    ...
    case square.column > activeSquare.column:
      const columnIndexAfterActive = squareSettings.columns - square.column - 1;

      if (prevSquareInColumn != undefined) {
        square.x = prevSquareInColumn.x + prevSquareInColumn.w;
      } else {
        square.x = activeSquare.x + activeSquare.w;
      }

      // console.log(
      //   'right',
      //   prevSquareInColumn,
      //   columnIndexAfterActive,
      //   square.x
      // );

      coef = (1 / totalColumnsRight) * columnIndexAfterActive;
      wCoef = easing(coef);
      square.w = totalSpaceRight * wCoef;
  ...
  //   const coef = (1 / totalColumnsLeft) * (square.column + 1);
  ...
  //   console.log('right', prevSquareInColumn, columnIndexAfterActive, square.x);

  //   const coef = (1 / totalColumnsRight) * columnIndexAfterActive;
  //   const wCoef = easing(coef);
  //   square.w = totalSpaceRight * wCoef;
